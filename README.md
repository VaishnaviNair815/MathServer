...
<head>
    ...
    <style>
        body {
            font-size: 20px;
            background-color:rgb(41, 82, 195);
            color:rgb(57, 144, 215);
        ...
        input[type="submit"] {
            padding: 8px 16px;
            font-size: 16px;
            background-color: rgb(230, 88, 112);
            color: #111;
            border: none;
            cursor: pointer;
        }
...
![alt text](<Screenshot 2025-05-05 142440.png>)
## HOMEPAGE:
![alt text](<Screenshot 2025-05-05 142029.png>)
